...
@coach.route('/coachProfile/<CoachID>', methods=['POST'])
...
@coach.route('/ScoutingReport/<playerID>', methods=['POST'])
...
@coach.route('/coachProfile/<coachID>', methods=['DELETE'])
...
@coach.route('/roster/<collegeid>', methods=['DELETE'])
...
@coach.route('/PlayerProfile/<PlayerID>', methods=['GET'])
...
@coach.route('/PlayerStats/<PlayerID>', methods=['GET'])
...
@coach.route('/ColTeam_Stats/<collegeid>', methods=['PUT'])
...
@coach.route('/colRoster/<collegeid>/<playerid>', methods=['PUT'])
